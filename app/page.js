...
import { FeatureBeatongrid } from "./_components/FeatureBeatongrid";
import { UserButton, useUser } from "@clerk/nextjs";

export default function Home() {
  return (
    <div
      className="relative  my-10 flex  flex-col items-center justify-center">
      <Navbar />
      <div
      ...
      <div className="px-4 py-10 md:py-20">
        <h1
          ...
          {"Revoutionize your website with AI Agent Care"
            .split(" ")
            .map((word, index) => (
              <motion.span
                key={index}
  ...
  return (
    <nav
      ...
      {!user? <Link href={"/sign-in"}> <button
        ...
        Login
      </button> </Link>:<div className="flex items-center gap-2">
        <UserButton/>
